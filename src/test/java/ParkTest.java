...
public class ParkTest {
    ...
    public void setUp() throws Exception {
        ...
        File app = new File("/Users/admin/Library/Developer/Xcode/DerivedData/Capalaba_Park-aurkdsrvsfwyrzdrtuymqrgxlali/Build/Products/Debug-iphonesimulator/Capalaba Park.app");
    ...
    public void test02() throws InterruptedException {
        ...
        Thread.sleep(1500);
        System.out.println("No Earn Title!");
        driver.findElement(By.name("Redeem")).click();
        Thread.sleep(1500);
        System.out.println("No Redeem Title!");
